...
public class WeatherFragment extends Fragment {
	...
	protected void initControlsAndRegEvent() {
		todayWhIcon = (ImageView) layoutView.findViewById(R.id.todayWhIcon);
		tv_todaydate = (TextView) layoutView.findViewById(R.id.tv_todaydate);
		tv_currentTemperature = (TextView) layoutView.findViewById(R.id.tv_currentTemperature);
		tv_today_Temp = (TextView) layoutView.findViewById(R.id.tv_today_Temp);
		tv_today_windspeed = (TextView) layoutView.findViewById(R.id.tv_today_windspeed);
		tomorrowWhIcon = (ImageView) layoutView.findViewById(R.id.tomorrowWhIcon);
		tv_tomorrowdate = (TextView) layoutView.findViewById(R.id.tv_tomorrowdate);
		...
		tv_tomorrow_windspeed = (TextView) layoutView.findViewById(R.id.tv_tomorrow_windspeed);
		tv_tomorrow_Temp = (TextView) layoutView.findViewById(R.id.tv_tomorrow_Temp);
